...
showreservfenbtn = document.querySelector(".reserv"),
...
showreservfenbtn.addEventListener("click", (e)=>{
    ...
    bookImg.setAttribute("src", e.target.parentNode.parentNode.parentNode.firstElementChild.firstElementChild.src);
    bookTitle.textContent = e.target.parentNode.parentNode.firstElementChild.textContent;
    bookAuteur.textContent = e.target.parentNode.parentNode.firstElementChild.nextElementSibling.firstElementChild.textContent;
